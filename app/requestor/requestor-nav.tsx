...
export function RequestorNav({ user }: RequestorNavProps) {
  ...
  const navItems = [
    { href: '/requestor', label: 'Dashboard', icon: FileText },
    { href: '/requestor/request/new', label: 'New Request', icon: Plus },
    { href: '/requestor/requests', label: 'My Requests', icon: Send },
    { href: '/requestor/history', label: 'History', icon: History },
  ];
          ...
          <div className="flex items-center space-x-8">
            <div className="flex-shrink-0">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-foreground">AFT Requestor</h1>
              </div>
            </div>
