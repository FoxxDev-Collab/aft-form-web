...
export function SMENav({ user }: SMENavProps) {
  ...
  const navItems = [
    { href: '/sme', label: 'Dashboard', icon: FileText },
    { href: '/sme/requests', label: 'Signature Requests', icon: UserCheck },
    { href: '/sme/history', label: 'Signature History', icon: History },
  ];
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            <div className="flex-shrink-0">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-foreground">AFT SME</h1>
              </div>
            </div>
          ...
          <div className="hidden sm:flex sm:items-center sm:space-x-4">
            ...
            <Badge className="bg-green-100 text-green-800 dark:bg-green-900 dark:text-green-200">
              {getRoleBadgeText(user?.role || 'sme')}
            </Badge>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
