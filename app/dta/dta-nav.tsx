...
export function DTANav({ user }: DTANavProps) {
  ...
  const navItems = [
    { href: '/dta', label: 'Dashboard', icon: Database },
    { href: '/dta/requests', label: 'Transfer Requests', icon: FileText },
    { href: '/dta/transfers', label: 'Active Transfers', icon: ArrowRightLeft },
    { href: '/dta/history', label: 'Transfer History', icon: History },
  ];
        ...
        <div className="flex justify-between h-16">
          <div className="flex items-center space-x-8">
            <div className="flex-shrink-0">
              <div className="flex items-center space-x-2">
                ...
                <h1 className="text-xl font-bold text-foreground">AFT DTA Portal</h1>
              </div>
            </div>
          ...
          <div className="hidden sm:flex sm:items-center sm:space-x-4">
            ...
            <Badge className="bg-blue-100 text-blue-800 dark:bg-blue-900 dark:text-blue-200">
              {getRoleBadgeText(user?.role || 'dta')}
            </Badge>
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
